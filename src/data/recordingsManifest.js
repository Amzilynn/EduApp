...
export const recordingsManifest = {
  ...
  alphabetHints: [
    ...
    { text: 'Lune', lang: 'fr', category: 'alphabet' },
    { text: 'Soleil', lang: 'fr', category: 'alphabet' },
    { text: 'Pomme', lang: 'fr', category: 'alphabet' },
    { text: 'Arbre', lang: 'fr', category: 'alphabet' },
    { text: 'Avion', lang: 'fr', category: 'alphabet' },
    { text: 'Livre', lang: 'fr', category: 'alphabet' },
    { text: 'Oiseau', lang: 'fr', category: 'alphabet' },
    { text: 'Fleur', lang: 'fr', category: 'alphabet' },
    { text: 'Lapin', lang: 'fr', category: 'alphabet' },
