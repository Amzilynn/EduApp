...
output_dir = Path("/mnt/EDUAPP/recordings_girl_v16")
output_dir.mkdir(parents=True, exist_ok=True)

ref_voice = "/mnt/EDUAPP/reference_voices/XTTSV2/Frenchgirl/girl-voice-fr.mp3"

# 2. Targeted regeneration - grandmère et père
tasks = {
    "la_grand_m_re_v1": "C'est la grand-mère.",
    "la_grand_m_re_v2": "La grand-mère !",
    "la_grand_m_re_v3": "Grand-mère !",
...
# 3. Run Synthesis
print("Initializing XTTS model for French Girl V16...")
try:
    ...
    print(f"\nGirl V16 complete! Files are in: {output_dir}")
