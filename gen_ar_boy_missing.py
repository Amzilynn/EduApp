...
def main():
    ...
    phrases = [
        ('mother', 'أُمّ'), ('brother', 'أَخ'), ('sister', 'أُخْت'),
        ('grandmother', 'جَدَّة'),
        ('orange', 'بُرْتُقَالِيّ'), ('blanc', 'أَبْيَض'), ('noir', 'أَسْوَد'),
        ('blue', 'أَزْرَق'), ('jaune', 'أَصْفَر'), ('rouge', 'أَحْمَر'), ('green', 'أَخْضَر'),
        ('violet', 'بَنَفْسَجِيّ'), ('pink', 'وَرْدِيّ'),
    ...
    print("\nDone! Missing Arabic Boy phrases variants generated.")
