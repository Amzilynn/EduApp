...
print("Preparing reference voice from arabic boyy.mp4...")

# Source: arabic boyy.mp4 (video) — extract audio, normalize, convert to 22050Hz mono WAV
...
# Extract audio: to mono 22050Hz WAV, normalized to -3dB peak
...
output_dir = Path("/mnt/EDUAPP/public/recordings/test_arabicboy")
...
print(f"\nDone! Generated {generated}/{len(phrases)} MP3 files using arabic boyy reference.")
